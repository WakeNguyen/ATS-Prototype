                        ...
                        >
                          ...
                          >
                            <span className="text-[10px] text-slate-300 truncate font-medium group-hover:text-emerald-300 transition-colors">
                              {j.location ? j.location : <span className="text-slate-500 italic">—</span>}
                            </span>
                              ...
                              <div className="space-y-1">
                                ...
                                {clientForm.address && (
                                  <button
                                    type="button"
                                    onClick={() => {
                                      handleUpdateJobField(j.id, "location", clientForm.address);
                                ...
                                {(clientForm.branches || [])
                                  .filter(b => !b.is_headquarter && (b.address || b.city))
                                  .map((branch) => {
                                    const branchVal = branch.address || branch.city;
                                    const isSelected = (j.location || "").trim() === branchVal.trim();
                                    return (
                                      <button
                                        key={branch.id}
                                        type="button"
                                        onClick={() => {
                                          handleUpdateJobField(j.id, "location", branchVal);
                                          setEditingLocationJobId(null);
                                        }}
                                        className={`w-full text-left p-1.5 rounded border transition-colors cursor-pointer flex flex-col space-y-0.5 ${
                                          isSelected
                                ...
                                <button
                                  type="button"
                                  onClick={() => {
                                    handleUpdateJobField(j.id, "location", "");
                                    setEditingLocationJobId(null);
                                  }}
                              ...
                              <div className="pt-1.5 border-t border-slate-800 space-y-1">
                                ...
                                <div className="flex items-center space-x-1">
                                  <input
                                    ...
                                    onKeyDown={(e) => {
                                      if (e.key === "Enter") {
                                        handleUpdateJobField(j.id, "location", tempLocation.trim());
                                        setEditingLocationJobId(null);
                                      }
                                    }}
                                  />
