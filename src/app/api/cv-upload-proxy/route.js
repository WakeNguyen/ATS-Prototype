...
export async function POST(request) {
  try {
    ...
    if ((process.env.DB_SCHEMA || 'public') === 'sandbox') {
      forwardForm.append('baseUrl', 'https://ats-dev.thucnguyen8n.space');
    }

    const n8nUrl = process.env.N8N_CV_UPLOAD_WEBHOOK_URL || 'https://n8n.example.com/webhook/cv-upload';
