        ...
        {allKnownTags.map((tagName) => {
          ...
          return (
            ...
            >
              ...
              {allowDelete && (
                <>
                  <Popover open={isRenaming} onOpenChange={(open) => { if (!open) handleCancelRename(); }}>
                    <PopoverTrigger
                      type="button"
                    ...
                    <PopoverContent
                      ...
                      side="bottom"
                      sideOffset={6}
                      className="bg-slate-900 border border-slate-700 rounded-xl p-3 shadow-2xl w-64 text-left font-normal"
      ...
      <div className="relative inline-flex items-center gap-1 flex-wrap">
        {normalizedTags.length === 0 ? (
          <PopoverTrigger
            ...
            className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] text-slate-500 hover:text-slate-300 hover:bg-slate-800/80 border border-dashed border-slate-700/60 transition-colors cursor-pointer"
          ...
          <PopoverTrigger
            type="button"
            onClick={handleOpenPopover}
            className="group/tag inline-flex items-center gap-1 flex-wrap cursor-pointer bg-transparent border-0 p-0 text-left"
        ...
        <PopoverContent
          ...
          side="bottom"
          sideOffset={6}
          className="w-72 p-3 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl text-slate-200 text-xs space-y-3"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold text-xs disabled:opacity-40 cursor-pointer"
              >
                <Plus size={12} />
              </button>
            </div>
                ...
                {allKnownTags
                  ...
                  .map((k) => (
                    <button
                      ...
                      className="px-1.5 py-0.5 rounded bg-slate-800/60 hover:bg-slate-800 text-slate-400 hover:text-slate-200 text-[10px] transition-colors cursor-pointer"
                    >
                      + {k}
                    </button>
                  ))}
          ...
          <div className="flex items-center justify-end gap-2 pt-1 border-t border-slate-800">
            ...
            <button
              ...
              disabled={saving}
              className="px-3 py-1 rounded bg-emerald-600 hover:bg-emerald-500 text-white font-semibold text-[11px] flex items-center gap-1.5 disabled:opacity-50 cursor-pointer"
            >
