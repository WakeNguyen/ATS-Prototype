...
function CampaignsContent() {
  ...
  const renderCampaignStatusBadge = (status) => {
    switch (status) {
      case "Running":
        return (
      ...
      <div className="flex-1 overflow-hidden flex flex-col p-5">
        ...
        {activeTab === "campaigns" && (
          <div className="flex-1 flex flex-col min-h-0 space-y-4">
                    ...
                    campaigns.map((c) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-3 px-3 whitespace-nowrap">
                            {renderCampaignStatusBadge(c.status)}
                          </td>
            ...
            {selectedCampaignId && (
              <div className="flex-1 flex flex-col border border-slate-800 rounded-xl bg-slate-900/70 overflow-hidden shadow-lg min-h-0">
                            ...
                            <div className="space-y-1.5 text-xs">
                              ...
                              <div className="flex justify-between items-center">
                                <span className="text-slate-400 flex items-center gap-1">
                                  ...
                                  <span className="text-slate-500 cursor-help" title="Maximum target groups to post. Batches are automatically dispatched in safe quotas (18 groups/run, 24h per-group cooldown, 90-100s anti-spam pacing).">
                                    <Info size={11} />
                                  </span>
                                </span>
                                <span className="text-slate-200 font-mono font-bold text-emerald-400">
                                  {campaignDetail?.target_quota ?? 20} groups
                                </span>
                              </div>
                              <div className="flex justify-between">
