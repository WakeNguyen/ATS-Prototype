...
Đã xác nhận trực tiếp: domain này KHÔNG phải app của bạn — Vercel dashboard của user (`trithuc1995hcm-7590`) đang có **0 project**, và mở URL đó ra chỉ thấy trang "Acme Inc." demo của người khác. Nghĩa là hiện tại **không có CV/notification/log lỗi nào tới được app hay Supabase thật cả** qua 3 node này.
