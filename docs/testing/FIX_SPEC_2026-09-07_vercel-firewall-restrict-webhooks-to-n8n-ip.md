...
- **Name:** `Allow n8n VPS`
- **If:** `IP Address` `equals` `103.xxx.xxx.xxx`
- **Then:** `Bypass`
...
- **If (cả 2 điều kiện, nối bằng AND):**
  ...
  - `IP Address` `not equals` `103.xxx.xxx.xxx`
- **Then:** `Deny`
