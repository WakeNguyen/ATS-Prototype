...
**KHÔNG đổi** node "Call VPS Bridge: ..." (`http://172.18.0.1:5680/...`) — đây là n8n gọi sang VPS Bridge nội bộ, không liên quan tới nơi host app Next.js. Cũng không đổi URL webhook trigger của chính n8n (`https://n8n.yourdomain.com/webhook/...`) — đó là địa chỉ app gọi VÀO n8n, không đổi khi app chuyển chỗ host.
