...
2. APIs & Services → **OAuth consent screen**:
   ...
   - Thêm **Test users**: nhập chính xác các địa chỉ Gmail của những người được phép dùng ATS (bao gồm `trithuc.1995.hcm@gmail.com` và bất kỳ ai khác User chỉ định).
...
- `ALLOWED_EMAILS` — danh sách email được phép, cách nhau bằng dấu phẩy, ví dụ: `trithuc.1995.hcm@gmail.com,nguoikhac@gmail.com`.
