...
const sql = postgres('postgresql://postgres:ATS3_Supabase_SecurePass2026!@db.mock-supabase-project.supabase.co:5432/postgres?options=-c%20search_path%3Dpublic', {ssl: 'require'});
